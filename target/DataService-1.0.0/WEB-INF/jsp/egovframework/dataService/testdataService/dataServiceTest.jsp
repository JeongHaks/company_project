...
<!-- 탭 메뉴 -->
    <div class="tab-container">
        <div class="tab-button active" onclick="selectTab(this)">자동차 등급별 현황</div>
        <div class="tab-button" onclick="selectTab(this)">4등급 차량 현황</div>
        <div class="tab-button" onclick="selectTab(this)">4등급 차량의 등급 세분류</div>
    </div>
    ...
    <!-- 엑셀 다운로드 -->
    <button type="button" class="excel-button" onclick="downloadExcel()">엑셀 다운로드</button>    
    <!-- 테이블 -->
    <table>
        <thead>
            <tr>
